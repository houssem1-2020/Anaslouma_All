...
function StockRepture() {
    ...
    return (  <>
        ...
        <div className='container-fluid'>
            Selectionnez le mode de paimment : 
            <ul>
                <li>Carte bancaire </li>
                <li>Versemment Postale ou bancaire </li>
                <li>Espéce lors de la rencontre </li>
            </ul>
            <Button className='bg-success text-white' fluid onClick={() => PaymmentFunc() } ><Icon name='payment' /> Paimment</Button>
        </div>
