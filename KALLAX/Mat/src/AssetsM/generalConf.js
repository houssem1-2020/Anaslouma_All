...
const GConf = {
    ...
    proffListe : [
        {id:1, colL: 4 , color:'#e3ebfc', tag:'Plombier',  link:'Plombier', genre:'Plombier', text:'Plombier', imageSrc:'Plombier.gif'},
        {id:2, colL: 4 , color:'#e3ebfc', tag:'Électricien',  link:'Électricien', genre:'Électricien', text:'Électricien', imageSrc:'Électricien.gif'},
        {id:3, colL: 4 , color:'#e3ebfc', tag:'Serrurier',  link:'Serrurier', genre:'Serrurier', text:'Serrurier', imageSrc:'Serrurier.gif'},
        {id:3, colL: 4 , color:'#e3ebfc', tag:'Chauffagiste',  link:'Chauffagiste', genre:'Chauffagiste', text:'Chauffagiste', imageSrc:'Chauffagiste.gif'},
        {id:3, colL: 4 , color:'#e3ebfc', tag:'Vitrier',  link:'Vitrier', genre:'Vitrier', text:'Vitrier', imageSrc:'Vitrier.gif'},
        ...
        {id:3, colL: 4 , color:'#e3ebfc', tag:'Jardinier',  link:'Jardinier', genre:'Jardinier', text:'Jardinier', imageSrc:'Jardinier.gif'},
        {id:3, colL: 6 , color:'#e3ebfc', tag:'Couvreur',  link:'Couvreur', genre:'Couvreur', text:'Femme de Ménage', imageSrc:'femme-de-menage.gif'},
        {id:3, colL: 6 , color:'#e3ebfc', tag:'Peinture',  link:'Peinture', genre:'Peinture', text:'Garde Enfant', imageSrc:'garde-enfant.gif'},
    ...
    profTags : {
        ...
        Plombier:[
            ...
            },
            {
                ...
                description: "Réparation des toilettes qui fuient, qui se bouchent ou qui ne fonctionnent  ",
