...
const AjouterPage = ({catalogueToAdd,setCataToAdd,AjouterAuCatalogue, loaderState, OnKeyPressFunc}) =>{
    return(<>
        <div className='card card-body shadow-sm mb-2 '>
            <h5>Ajouter Page</h5>
            <div className='mb-0'>Nom </div>
            <Input icon='tags' className='mb-2' onKeyPress={event => OnKeyPressFunc(event)} iconPosition='left' placeholder='nom' value={catalogueToAdd.genre} onChange={(e) => setCataToAdd({...catalogueToAdd, genre: e.target.value })} />
            ...
            <Input icon='paint brush' type='color' onKeyPress={event => OnKeyPressFunc(event)} className='mb-2 p-2' iconPosition='left' value={catalogueToAdd.color} onChange={(e) => setCataToAdd({...catalogueToAdd, color: e.target.value })} />
            <br />
...
const ModifierPage = ({catalogueD, tagName, loaderState, UpdateCatGenData, UpdateCatalogue, pagesList, setTagN, OnKeyPressFunc}) =>{
    return(<>
        <div className='card card-body shadow-sm mb-2 '>
            <h5>Selectioner</h5>
            ...
            <h5>Modifier Page</h5>
            <div className='mb-0'>Nom </div>
            <Input icon='tags' className='mb-2' onKeyPress={event => OnKeyPressFunc(event)} iconPosition='left' placeholder={catalogueD[tagName].genre} onChange={(e) => UpdateCatGenData(tagName, 'genre', e.target.value)} />
            
            <div className='mb-0'>nombre de Page</div>
            <Input icon='file' className='mb-2' onKeyPress={event => OnKeyPressFunc(event)} iconPosition='left' placeholder={catalogueD[tagName].page} onChange={(e) => UpdateCatGenData(tagName,'page', e.target.value )} />

            <div className='mb-0'>Couleur</div>
            <Input icon='paint brush' type='color' onKeyPress={event => OnKeyPressFunc(event)} className='mb-2 p-2' iconPosition='left' placeholder={catalogueD[tagName].color} onChange={(e) => UpdateCatGenData(tagName,'color',e.target.value )} />
            <br />
...
function CataloguePage() {
    ...
    const panes = [
        {
          menuItem: 'Modifier',
          render: () => <ModifierPage catalogueD={catalogueD} tagName={tagName} loaderState={loaderState} UpdateCatGenData={UpdateCatGenData} UpdateCatalogue={UpdateCatalogue} pagesList={pagesList}  setTagN={setTagN} OnKeyPressFunc={OnKeyPressFunc} />,
        },
        {
          menuItem: 'Imprimer',
          render: () => <ImprimerCard />,
