...
function CamionFactureInfo() {
    ...
    return ( <> 
            ...
            <div className="col-12 col-lg-8">
                ...
                <div className='row'>
                    ...
                    <div className='col-6'>
                        ...
                        <div className='text-secondary'><b>CLIENT: </b> {loading ? factureData.Name : SKLT.BarreSkl }</div>
                    </div>
                </div>
                <br />
                <br />
        ...
        <FrameForPrint frameId='printFacture' src={`/Pr/Camion/info/factureTemp/${FID}`} />
