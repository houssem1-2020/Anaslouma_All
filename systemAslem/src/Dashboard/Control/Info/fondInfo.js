...
const PrintBSBL = ({BonSL, setBonSL, PrintFunction , OnKeyPressFunc}) =>{
    return (<>
            <div className='card card-body shadow-sm mb-2'>
                <h5>Bond de Sortie / Livraision </h5>
                <Input icon='user' size="small" iconPosition='left' onKeyPress={event => OnKeyPressFunc(event)}  placeholder='Chauffeur '  fluid className='mb-1' value={BonSL.chauffeur}  onChange={(e) => setBonSL({...BonSL, chauffeur: e.target.value })} />
                <div className='row'>
                    <div className='col-6'><Input onKeyPress={event => OnKeyPressFunc(event)} icon='map marker' size="small" iconPosition='left' placeholder='De'  fluid className='mb-1'  value={BonSL.de}  onChange={(e) => setBonSL({...BonSL, de: e.target.value })}/></div>
                    <div className='col-6'><Input onKeyPress={event => OnKeyPressFunc(event)} icon='map marker alternate' size="small" iconPosition='left' placeholder='Vers'  fluid className='mb-1' value={BonSL.vers}  onChange={(e) => setBonSL({...BonSL, vers: e.target.value })}/></div>
                </div>
        ...
        <div className="row">
            ...
            <Bounce bottom>
                <div className="sticky-top" style={{top:'70px'}}>
                    <TotaleCard />
                    <BtnsCard /> 
                    <PrintBSBL BonSL={BonSL} setBonSL={setBonSL} PrintFunction={PrintFunction} OnKeyPressFunc={OnKeyPressFunc} />      
                </div>
            </Bounce>
            </div>
        </div>
