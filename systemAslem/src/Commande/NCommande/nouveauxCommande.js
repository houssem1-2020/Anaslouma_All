...
import { Button,  Dropdown, Icon, Input, Item, Label, Loader, Form, Tab, TextArea } from 'semantic-ui-react';
...
function NouveauxCommande() {
    ...
    const [commandeD, setCommandeD] = useState({client: null, UID : UID , Comments:'', jour: Today.toISOString().split('T')[0], totale: 0 , prixGros: false, articles:[]})
    ...
    //const socket = io.connect(GConf.MainLink);
    /*#########################[UseEffect]##################################*/
    useEffect(() => {
        ...
        return (<>
                <div className=' card-body  mb-2'>
                    ...
                    <div className='row mb-2'>
                        ...
                        {/* <div className='col-4'>
                            <Button size="large" disabled={saveBtnState} className='rounded-pill bg-warning' onClick={ () => setArticleNow({...articleNow, Prix_vente : articleNow.Prix_gros})} fluid> Gros</Button>
                        </div> */}
                    </div>
