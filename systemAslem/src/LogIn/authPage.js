        ...
        <div className='row'>
            ...
            <div className='col-12  col-lg-7'>
                ...
                <Bounce left>
                            ...
                            <div className='mb-2'>
                                <Input   icon='user' iconPosition='left' onKeyPress={event => OnKeyPressFunc(event)} placeholder='Auth Pour ..' className='shadow-sm w-login-input ' value={authUser}  onChange={(e) => setAuthUser(e.target.value)} />
                            </div>
                            <div className='mb-5'>
                            ...
                            <div className='mb-2'>
                                <Input   icon='key' iconPosition='left' placeholder='Clé Auth' onKeyPress={event => OnKeyPressFunc(event)}  className='shadow-sm w-login-input '  value={authKey}  onChange={(e) => setAuthKey(e.target.value)} />
                            </div>
                            <div className='mb-5'>
