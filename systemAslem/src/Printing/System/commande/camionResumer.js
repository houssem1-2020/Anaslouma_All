...
function CommandeGroupResumer() {
    ...
    const MakeSum = () =>{
        ...
        return ((tot + (1.000 * num)).toFixed(3))
    }
    /*########################[Card]########################*/
    const FactureHeader = () =>{
        return(<>
                ...
                <div className='row'>
                    ...
                    <div className='col-6'>
                        ...
                        <div className='text-secondary'><b>Camion : {CID} </b>  </div>
                    </div>
                </div>
        </>)
    }
                ...
                <tbody>
                    {factureList.map( (artData, index) => 
                        <tr key={index}>
                            ...
                            <td>{artData.Name}</td>
                            <td>{(parseFloat(artData.Tota) + 1.000).toFixed(3)}</td>
                            <td>{artData.Gouv}</td>
                            <td>{artData.Deleg}</td>
                            <td>{artData.Phone}</td>
                            <td> </td>
