...
function CataloguePrint() {
    ...
    const SimpleArticleCard = (props) =>{
        return(<>
            <div className='p-2 text-center  h-100'>
                ...
                <div className='p-1 mt-1 rounded-pill text-start d-inline-block pe-2 ps-2 text-white mb-2 d-none' style={{backgroundColor: props.color}} > {props.data ? <b>{(props.data.Prix_vente).toFixed(3)}</b>: ''} D.T</div>
    ...
    const TempleteCard = (props) =>{
        const MainPage = (props) =>{
            return(<>
                    ...
                    <div className='bg-transparent ' style={{height:'1015px', width:'100%'}}>
                        ...
                        <div className='text-center'><img src={`https://assets.ansl.tn/Images/Articles/1665565464217-4181577689440.jpeg`} className='img-responsive' width={`${props.widtPhoto}%`} height={`${props.heigPhoto}px`} /> </div>                     
                        <div className='p-2 mt-2' style={{backgroundColor:'#ffc107', marginLeft:'400px', borderRadius: '20px 0px 0px 20px'}}>
                            <h5 className='p-2 ps-4'>  JUDY NETTOYANT  </h5>
                        </div>
        ...
        const NormalPage = (props) =>{
            return(<>
                ...
                <div className={`${props.tag == 42 ? 'bg-info' : 'bg-white'} `} style={{height:'1148px', width:'100%'}}>
    ...
    const AllPages = (props)  =>{
        ...
        return(<>
            ...
            {/* {
                catalogueD.map( (data,index) => <><TempleteCard tag={index} /> <div className='breack-page-here'></div> </>)
            } */}
        </>)
    }
    return (<>
