...
function UpdatePage() {
    ...
    let [Offline, setOffline] = useState(JSON.parse(localStorage.getItem(`${GConf.SystemTag}_Offline`))); 
    ...
    const UpdateItem = (allTable, whTableTag) =>{
            ...
            setOffline(JSON.parse(localStorage.getItem(`${GConf.SystemTag}_Offline`)))
    }
    const UpdateAllItem = () =>{
    ...
    const SaveFactureFunc = (targetIndex) => {
        ...
        .then(function (response) {
            if(response.status = 200) {
                ...
                setLS(false)
                SaveNotification('factureAjouter',GConf.SystemTag, factureSelected)
    ...
    const SaveArticleFunc = (targetIndex) => {
        ...
        axios.post(`${GConf.ApiLink}/stock/ajouter`, {
            ...
            if(response.data.affectedRows) {
                ...
                setLS(false)
                SaveNotification('stockSaveArticle',GConf.SystemTag, ArticleSelected)
    ...
    const SaveClientFunc = (targetIndex) => {
        ...
        axios.post(`${GConf.ApiLink}/client/ajouter`, {
            ...
            if(response.data.affectedRows) {
                ...
                SaveNotification('clientAjouter',GConf.SystemTag, clientSelected)
                setLS(false)
    ...
    const SaveCamionFunc = (targetIndex) => {
        ...
        axios.post(`${GConf.ApiLink}/camions/ajouter`, {
            ...
            if(response.data.affectedRows) {
                ...
                setLS(false)
                SaveNotification('camionAjouter',GConf.SystemTag, CamionSelected)
