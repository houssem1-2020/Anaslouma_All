const GConf = {
    ...
    // main variables
    ApiLink : 'https://api.system.ansl.tn/API/Ansl', //https://api.system.ansl.tn/API/ 
    themeColor : '#3acacf',
    TostErrorGonf : {
    ...
    //main stat card
    LinkCard: [
        { id: 1, col: 3 , tag:"article", dataTag:'articlesNum',  icon: 'truck-flatbed', link:'alimenatire', smallT: 'Article', desc: 'Alimentaire' },
        ...
        { id: 5, col: 3 , tag:"camion", dataTag:'camionsNum', icon: 'pie-chart-fill', link:'resumer', smallT: 'Camions', desc: 'Resumer'},
        ...
        { id: 8, col: 3 , tag:"camion", dataTag:'camionsNum', icon: 'pen-fill', link:'notes', smallT: 'Camions', desc: 'Notes'},
    ],
